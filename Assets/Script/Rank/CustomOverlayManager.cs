...
namespace Platform
{
    public class CustomOverlayManager : MonoBehaviour
    {
        ...
        [SerializeField] Image _playImage = null;
        [SerializeField] Image _pauseImage = null;
